...
final class AppraisalPhExtractionRules
{
    public static function technical(): array
    {
        return [
            ...
            'numero_pisos' => ['pisos', 'niveles', 'planta baja'],
            'numero_sotanos' => ['sotano', 'sotanos'],
            'numero_ascensores' => ['ascensor', 'ascensores'],
            'numero_unidades' => ['unidades privadas', 'unidades inmobiliarias'],
            'numero_oficinas' => ['oficinas'],
            'numero_locales' => ['locales'],
            'numero_parqueaderos' => ['parqueaderos', 'garajes', 'estacionamientos'],
            'numero_depositos' => ['depositos', 'cuartos utiles'],
