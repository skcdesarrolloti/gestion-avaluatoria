...
{
    public function store(array $files, string $appraisalId, int $owner, AppraisalRepository $repo): int
    {
        ...
        foreach (array_keys($files['name']) as $index) {
            ...
            $this->storeOne($files, $index, $appraisalId, $owner, $repo);
            $stored++;
        }
    ...
    private function storeOne(array $files, int $index, string $appraisalId, int $owner, AppraisalRepository $repo): void
    {
