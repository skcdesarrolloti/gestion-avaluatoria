    ...
    public function build(array $profile): array
    {
        $sections = [
            ...
            ['5.2 Reglamentación, índices y potencial básico', $this->paragraph([
                ...
                $this->line('Área terreno normativa m²', $profile['land_area_normative_m2'] ?? ''),
                $this->line('Frente del lote m', $profile['lot_front_normative_m'] ?? ''),
                $this->line('Modalidad normativa evaluada', $profile['normative_modality'] ?? ''),
                $this->line('Área neta normativa m²', $profile['net_land_area_m2'] ?? ''),
