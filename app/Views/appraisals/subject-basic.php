...
$textLabels = [
    ...
    'predial_base_value' => ['Avalúo catastral vigente (base gravable)', 'Ej. $ 302.123.000'],
    'predial_destination_code' => ['Destino predial (código)', 'Ej. 01'],
    'predial_destination_description' => ['Destino predial (descripción)', 'Ej. Residencial, comercial, mixto, institucional'],
    'predial_rate_per_mille' => ['Tarifa predial (x mil)', 'Ej. 6.8 x mil'],
    'predial_bill_source' => ['Soporte impuesto predial', 'Ej. Factura No. 2200101016345721-02 / vigencia 2022'],
