<?php
/** @var array<int, array{src:string, asks:string, use:string}> $normativeAcademy */
    ...
    <section class="rounded-xl border border-indigo-100 bg-indigo-50 p-4 text-sm leading-6 text-indigo-950">
        <div class="flex flex-wrap items-start justify-between gap-3">
            <div>
                ...
                <p class="mt-1 text-xs text-indigo-800">Guía corta por módulo: qué exige revisar y cómo se traduce en esta pantalla.</p>
            </div>
        ...
        <div class="mt-3 overflow-x-auto rounded-lg border border-indigo-100 bg-white">
            <table class="w-full min-w-[52rem] text-left text-xs leading-5">
