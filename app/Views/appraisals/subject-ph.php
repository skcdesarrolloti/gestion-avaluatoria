...
<section data-ph-section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"
    ...
    <?php else: ?>
        ...
        <div class="mt-5 rounded-xl border border-blue-100 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
            <strong>Banco técnico PH.</strong> La llave funcional es el nombre de la copropiedad.
        ...
        <?php require BASE_PATH . '/app/Views/appraisals/subject-ph-deliverable-preview.php'; ?>
