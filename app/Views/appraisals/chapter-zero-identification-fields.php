...
$support = static fn (string $text): string => '<span class="mt-1 block text-xs leading-5 text-slate-500">Soporte: ' . e($text) . '</span>';
?>
<label class="label md:col-span-2">Nombre del avalúo
    ...
    <?= $support('control interno del expediente; ayuda a identificar el encargo y no reemplaza la identificación registral.') ?>
</label>
<label class="label">Cliente / contratante
    ...
    <?= $support('NTS S 03 y NTS I 01: identificación del solicitante o contratante del informe.') ?>
</label>
<label class="label">Solicitante
    ...
    <?= $support('NTS S 03: identificación de quien formula o canaliza la solicitud del avalúo.') ?>
</label>
<label class="label">Identificación del solicitante
    ...
    <?= $support('NTS I 01: identificación suficiente del solicitante y trazabilidad del encargo.') ?>
</label>
<label class="label">Calidad/cargo en que solicita
    ...
    <?= $support('NTS S 03: permite precisar representación, cargo, interés o calidad con que se solicita la valuación.') ?>
</label>
<label class="label">Propietario del inmueble
    ...
    <?= $support('NTS S 03: identifica los derechos o intereses relacionados con el activo objeto de estudio.') ?>
</label>
<label class="label">Destinatario del informe
    ...
    <?= $support('NTS S 03: destinatario y uso autorizado del informe.') ?>
</label>
...
<label class="label md:col-span-2">Uso previsto del informe
    ...
    <?= $support('NTS S 03 y NTS I 01: uso previsto de la valuación y propósito comunicado al lector.') ?>
</label>
...
<label class="label md:col-span-2">Descripción del encargo valuatorio
    ...
    <?= $support('NTS S 03: define qué encomienda recibió el valuador antes de precisar alcance y limitaciones.') ?>
</label>
<label class="label md:col-span-2">Alcance o amplitud del informe
    ...
    <?= $support('NTS S 03: ámbito de uso, cobertura técnica e información considerada en el informe.') ?>
</label>
<label class="label md:col-span-2">Limitaciones y salvedades
    ...
    <?= $support('NTS S 03 y NTS S 04: condiciones contingentes o restrictivas y salvedades del valor.') ?>
</label>
<label class="label md:col-span-2">Hipótesis de trabajo
    ...
    <?= $support('NTS S 03 e IVS: hipótesis, supuestos especiales o condiciones de trabajo comunicadas al usuario.') ?>
</label>
<label class="label md:col-span-2">Documentos aportados o insumos
    ...
    <?= $support('NTS I 01: documentos, insumos e información examinada para soportar el informe.') ?>
</label>
<label class="label md:col-span-2">Texto adicional para memoria descriptiva
    ...
    <?= $support('Campo editorial interno: permite complementar el capítulo sin modificar datos estructurados.') ?>
</label>
<label class="label md:col-span-2">Observaciones generales
    ...
    <?= $support('Trazabilidad interna: observaciones del expediente; pasan al informe solo si el analista lo decide.') ?>
</label>
