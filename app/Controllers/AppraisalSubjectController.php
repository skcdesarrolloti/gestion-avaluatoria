    ...
    public function show(string $id): void
    {
        ...
        view('appraisals/subject', ['title' => 'Bien sujeto', 'record' => $record,
            ...
            'phCatalog' => ['status' => AppraisalPhCatalog::statusOptions(),
                ...
                'commonAreaGroups' => AppraisalPhCatalog::commonAreaGroups(),
                'typologyPriorities' => AppraisalPhCatalog::typologyPriorities(),
                'dotationLevels' => AppraisalPhCatalog::dotationLevels(),
                'normNotes' => AppraisalPhCatalog::normNotes(),
                'risks' => AppraisalPhCatalog::risks(), 'photos' => AppraisalPhCatalog::photos(), 'normativeAcademy' => AppraisalPhCatalog::normativeAcademy(),
                'deliverableFilter' => AppraisalPhCatalog::deliverableFilter()],
            ...
            'phActionDocumentId' => Session::pullFlash('ph_action_document_id'),
            'phActionTone' => Session::pullFlash('ph_action_tone'),
            'phActionMessage' => Session::pullFlash('ph_action_message'),
