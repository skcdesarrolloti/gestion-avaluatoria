...
final class AppraisalPhComparativeCatalog
{
    ...
    public static function commonAreaRules(): array
    {
        return [
            ...
            'juegos' => ['juegos infantiles', 'recreacion infantil', 'parque infantil'],
            ...
            'canchas' => ['cancha', 'canchas', 'zona deportiva', 'escenario deportivo'],
    ...
    {
        return [
            ['src'=>'Ley 675 · arts. 3, 19, 20 y 24', 'quote'=>'“Bienes comunes esenciales” y bienes que facilitan “uso o goce” del dominio particular.', 'use'=>'Identificar cuáles bienes comunes son soporte real de la unidad y cuáles son solo amenidades o menciones documentales.', 'report'=>'Al entregable pasan los comunes relevantes por tipología; el listado completo queda como soporte.'],
            ['src'=>'Ley 675 · arts. 25 a 31', 'quote'=>'Coeficientes, módulos de contribución y expensas comunes según reglamento.', 'use'=>'Vincular coeficiente, cuota, expensas, módulos o cargas con el bien sujeto; no tomar el primer coeficiente encontrado.', 'report'=>'Al entregable pasa el coeficiente o carga verificable; lo incierto queda como salvedad.'],
            ['src'=>'Decreto 1420 · arts. 21 y 22', 'quote'=>'Tratamiento valuatorio de inmuebles sometidos a PH: áreas privadas, áreas comunes y derechos derivados de coeficientes.', 'use'=>'Conectar unidad privada, matrícula, reglamento, escala, servicios comunes y derechos/cargas antes de concluir incidencia valuatoria.', 'report'=>'Al entregable pasa la descripción útil: pisos, ascensores, servicios comunes, distribución, incidencia PH y salvedades.'],
            ['src'=>'NTS S 03 / NTS I 01', 'quote'=>'Informe suficiente: alcance, información examinada, metodología, soportes y salvedades.', 'use'=>'Convertir el OCR y el reglamento en resúmenes depurados; no copiar páginas largas al informe.', 'report'=>'Al entregable va texto corto; el extracto documental queda debajo como respaldo.'],
            ['src'=>'NTS M 01', 'quote'=>'Método soportado en información pertinente, verificable y comparable.', 'use'=>'Comparar dotación común contra copropiedades de la misma tipología; si es mixta, separar componentes de uso.', 'report'=>'Al entregable pasa la lectura comparativa cuando incide en funcionalidad, deseabilidad o comercialización.'],
            ['src'=>'IVS 104 / IVS 106', 'quote'=>'Datos relevantes, documentación suficiente, supuestos y limitaciones trazables.', 'use'=>'Marcar cada dato como documento, visita, criterio, pendiente o alerta, según su confiabilidad.', 'report'=>'Al entregable pasan los datos confiables y las limitaciones necesarias; lo demás queda como trazabilidad.'],
            ['src'=>'IVS 400', 'quote'=>'Derecho inmobiliario, restricciones, cargas, características y circunstancias del activo.', 'use'=>'Revisar si la PH aporta seguridad, operación, imagen, restricciones, cargas o soporte común frente a comparables.', 'report'=>'Al entregable pasa la conclusión valuatoria, no el inventario completo del reglamento.'],
            ['src'=>'Ayuda interna', 'quote'=>'Los campos de incidencia no son artículos literales; son estructura de análisis.', 'use'=>'Funcional, comercial, operativa y cargas traducen los soportes PH al lenguaje valuatorio del informe.', 'report'=>'El entregable conserva la conclusión técnica y la fuente; no copia toda la matriz.'],
        ];
    }
