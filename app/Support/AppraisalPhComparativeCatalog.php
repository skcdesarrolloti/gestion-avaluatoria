...
final class AppraisalPhComparativeCatalog
{
    ...
    public static function normativeAcademy(): array
    {
        return [
            ...
            ['src'=>'Ayuda interna', 'quote'=>'Mención documental no equivale a verificación actual.', 'use'=>'Usar reglamento y OCR como punto de partida; confirmar lo material con visita, fotos, administración, paz y salvo, pólizas o certificados.', 'report'=>'Si no está confirmado, va como pendiente o salvedad; no como afirmación cerrada.'],
        ];
    }
