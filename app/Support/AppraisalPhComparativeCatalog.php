...
final class AppraisalPhComparativeCatalog
{
    ...
    public static function normativeAcademy(): array
    {
        return [
            ...
            ['src'=>'NTS M 01', 'quote'=>'Método soportado en información pertinente, verificable y comparable.', 'use'=>'Comparar dotación común solo contra copropiedades de la misma tipología: oficinas con oficinas, bodegas con bodegas, etc.', 'report'=>'Al entregable pasa la lectura comparativa cuando incide en funcionalidad, deseabilidad o comercialización.'],
