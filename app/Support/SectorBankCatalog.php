...
final class SectorBankCatalog
{
    ...
    {
        return [
            '01' => ['Identificación y localización', ['sector_country', 'sector_department', 'sector_city',
                'sector_neighborhood', 'sector_locality', 'sector_commune', 'sector_name',
                'sector_microsector', 'influence_area', 'sector_boundaries']],
            '02' => ['Localización y soporte cartográfico', ['sector_map_url', 'sector_latitude',
                'sector_longitude', 'sector_area_ha', 'sector_perimeter_m', 'sector_north_boundary',
                'sector_east_boundary', 'sector_south_boundary', 'sector_west_boundary', 'sector_source']],
    ...
    public static function sources(): array
    {
        return [
            ...
            ['geoportal_catastro', 'Base territorial', 'Geoportal / AMB Catastro', 'Autoridad catastral',
                '', 'SI', null],
            ...
            ['planeacion_cartagena', 'Normatividad', 'Secretaría de Planeación', 'Distrito de Cartagena',
                '', 'SI', null],
            ['empresas_servicios', 'Servicios públicos', 'Empresas prestadoras de servicios públicos',
                'Acuacar, Afinia, Surtigas, Pacaribe, Veolia u operador vigente',
                '', 'PARCIAL', null],
            ['cartagena_como_vamos', 'Indicadores urbanos', 'Cartagena Cómo Vamos',
                'Observatorio ciudadano de calidad de vida',
                'https://cartagenacomovamos.org/', 'NO', null],
            ['nts_aplicables', 'Normatividad', 'NTS aplicables', 'Registro Nacional de Avaluadores / ONAC',
                '', 'NO', null],
            ['epa_cartagena', 'Ambiental y riesgos', 'EPA Cartagena', 'Establecimiento Público Ambiental',
                '', 'SI', null],
            ['gestion_riesgo', 'Ambiental y riesgos', 'Gestión del Riesgo', 'Distrito de Cartagena',
                '', 'SI', null],
            ['dimar_cioh', 'Ambiental y riesgos', 'DIMAR / CIOH', 'Autoridad marítima',
                '', 'SI', null],
            ['cardique', 'Ambiental y riesgos', 'CARDIQUE', 'Autoridad ambiental',
                '', 'SI', null],
            ['transcaribe', 'Movilidad', 'Transcaribe', 'Sistema integrado de transporte',
                '', 'SI', null],
            ['movilidad_infraestructura', 'Movilidad', 'Entidades distritales de movilidad e infraestructura',
                'Distrito de Cartagena', '', 'SI', null],
            ['ipcc_pemp', 'Patrimonio', 'IPCC / PEMP', 'Patrimonio y cultura',
                '', 'SI', null],
            ['base_interna_skc', 'Mercado', 'Base interna SKC', 'SuCasa / InversKC',
                '', 'NO', null],
            ['lonja', 'Mercado', 'Lonja', 'Gremio inmobiliario',
                '', 'NO', null],
            ['portales_inmobiliarios', 'Mercado', 'Portales inmobiliarios', 'Fuentes abiertas de mercado',
                '', 'NO', null],
            ['investigacion_mercado', 'Mercado', 'Investigación del mercado', 'Perito / analista',
                '', 'NO', null],
            ...
            ['registro_fotografico', 'Soporte', 'Registro fotográfico de campo', 'Perito / analista',
                '', 'NO', null],
            ['imagenes_apoyo', 'Soporte', 'Imágenes viales y satelitales de apoyo', 'Fuentes visuales de consulta',
                '', 'NO', null],
        ];
    }
