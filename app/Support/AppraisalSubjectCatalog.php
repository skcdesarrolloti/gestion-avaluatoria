...
final class AppraisalSubjectCatalog
{
    ...
    public static function helps(): array
    {
        return [
            ...
            'predial_base_value' => 'Avalúo catastral o base gravable tomado de factura o liquidación predial. No reemplaza el valor comercial.',
            'predial_destination_code' => 'Código de dos dígitos que aparece como Destino en la factura predial.',
            'predial_destination_description' => 'Descripción confirmada del destino económico o soporte tarifario aplicable.',
