...
final class AppraisalSubjectCatalog
{
    ...
    public static function textKeys(): array
    {
        return ['subject_title', 'point_reference', 'address', 'address_certificate',
            ...
            'cadastral_reference', 'registry_office', 'predial_base_value',
            'predial_destination_code', 'predial_destination_description', 'predial_rate_per_mille',
            'predial_bill_source', 'restrictions', 'legal_urban_affectations',
    ...
    public static function selects(): array
    {
        ...
        return [
            ...
            'current_use' => ['Uso observado en visita', $uses], 'main_potential_use' => ['Uso potencial de mercado', $uses],
            'main_complementary_activity' => ['Actividad complementaria observada', $uses],
    ...
    public static function helps(): array
    {
        return [
            ...
            'predial_base_value' => 'Base gravable tomada de factura o liquidación predial. No reemplaza el valor comercial.',
            'predial_destination_code' => 'Código Destino de la factura predial. Se registra literal; no reemplaza el uso de suelo MIDAS.',
            'predial_destination_description' => 'Destino económico o tarifario confirmado: residencial, institucional, comercial, industrial, mixto u otro.',
            'predial_rate_per_mille' => 'Tarifa predial expresada en miles, tal como aparece en factura o liquidación.',
            'predial_bill_source' => 'Factura, vigencia o soporte usado para base gravable, destino y tarifa predial.',
            ...
            'current_use' => 'Uso físico u operativo observado en visita. No reemplaza la compatibilidad normativa, que se define en el numeral 5.',
            'main_potential_use' => 'Uso de mercado que podría capitalizar localización y condiciones del sujeto; su compatibilidad normativa se cruza en el numeral 5.',
