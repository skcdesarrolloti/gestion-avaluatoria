...
final class AppraisalPhCatalog
{
    ...
    public static function technicalGroups(): array
    {
        return [
            ...
            'configuracion' => ['Configuración general', [
                ...
                'numero_locales' => 'Número de locales', 'numero_parqueaderos' => 'Número de parqueaderos', 'parqueadero_relacion_sujeto' => 'Relación del parqueadero con el bien sujeto', 'parqueadero_identificacion_sujeto' => 'Identificación del parqueadero asignado o anexo',
            ...
            'soporte' => ['Bienes comunes y soporte operativo', [
                ...
                'equipamiento_tecnico' => 'Básculas, subestación, patios y áreas técnicas', 'alcance_planta_electrica' => 'Alcance de planta eléctrica',
    ...
    public static function technicalApplicability(): array
    {
        $base = ['fuente_documental', 'escritura_reforma', 'fuente_acto_ph', 'ciudad_municipio', 'direccion_referencia',
            ...
            'numero_parqueaderos', 'parqueadero_relacion_sujeto', 'parqueadero_identificacion_sujeto', 'numero_depositos', 'resumen_areas_conjunto', 'area_lote_matriz', 'area_construida_total', 'ubicacion_unidad',
            'bienes_comunes_esenciales', 'bienes_comunes_no_esenciales', 'areas_uso_exclusivo',
            'porteria_administracion_vigilancia', 'cctv_control_acceso', 'alcance_planta_electrica', 'usos_permitidos',
