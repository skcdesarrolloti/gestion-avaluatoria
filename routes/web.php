...
return [
    ...
    ['POST', '#^/avaluos/([a-f0-9]{32})/capitulo-0/preclasificacion$#', 'appraisals', 'saveChapterZeroPreclassification', true],
    ['POST', '#^/avaluos/([a-f0-9]{32})/capitulo-0/unidades$#', 'appraisals', 'saveChapterZeroUnits', true],
